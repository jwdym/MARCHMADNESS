...
for (i in 1985:2007){
  ...
  for(j in 1:n_teams){ELO_LIST[[i - 1984]][[j]] <- rep(0, nrow(TEMP_LIST[[j]]))}
  for (j in 1:n_game){
    #code here 
    for (k in 1:n_teams){
...
<<<<<<< HEAD
      ELO_LIST[[i-1984]][[k]][j] <- Get_ELO(k = 20, team = TEMP_LIST[[k]]$TeamID[1], df = TEMP_LIST, iter = j, baseline = 1000)
=======
      con <- Get_ELO(k = 20, teamid = TEMP_LIST[[k]]$TeamID, df = TEMP_LIST, iter = j, baseline = 1000)
      ELO_LIST[[i-1984]][[k]][j] <- con 
>>>>>>> fa7fcad4baeecc0250fcf023dcf6107d8c041a80
    }
